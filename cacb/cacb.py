...
class ContinuousActionContextualBanditModel:
    ...
    def __init__(
        ...
        self.logged_data = self._read_logged_data_file(data_file, memory) if data_file else np.array([])
        self.reg = None
    ...
    def predict(self, context, epsilon=0.05, exploration_width=1, exploration_strategy='smart'):
        """
        ...
        assert exploration_strategy in ['smart', 'aggressive', None], "Exploration strategy must be 'smart', 'aggressive' or None"
        ...
        if exploration_strategy == 'smart':
            ...
            if explored and cost_change < 0:
                ...
                return self._explore(costs_per_action, 1.0, exploration_width, direction)
